...
def cleanup_task1_xcom(**kwargs):
    dag_id = kwargs['dag'].dag_id
    task_id_to_clear = 'download_minio'  # task1
    XCom.clear(dag_id=dag_id, task_id=task_id_to_clear)
    print(f"XComs for task {task_id_to_clear} cleared!")
...
with DAG(
    ...
    task3 = PythonOperator(
        task_id = 'deleteXcom',
        python_callable = cleanup_task1_xcom,
        provide_context = True
    )
